...
public class FishingRodController : MonoBehaviour
{
    ...
    private Rigidbody rbCargo = null;

    private bool isCastFishingRod = false;
    private Buoyancy cargoBuoyancyController = null;
    ...
    void Start()
    {
        ...
        cargoBuoyancyController = whatIsHangingFromTheRope.GetComponentInParent<Buoyancy>();
    ...
    void Update()
    {
        ...
        if (cargoBuoyancyController != null && cargoBuoyancyController.GetIsUnderWater() && isCastFishingRod)
        {
    ...
    {
        if (isCastFishingRod || cargoBuoyancyController == null || cargoBuoyancyController.GetIsUnderWater())
    ...
    public bool GetIsReady(float floaterDepth  = 0)
    {
        if (!isCastFishingRod)
        {
            if (ropeLength + floaterDepth <= readyRopeLength)
                return true;
            return false;
        }
    ...
    public void SetCargoBuoyancyController(Buoyancy buoyancy)
    {
        cargoBuoyancyController = buoyancy;
    }
    
    public void SetCargoRigidbody(Rigidbody rb)
    {
        rbCargo = rb;
    }
